...
const addButton = { border: 'none', borderRadius: 9, padding: '11px 14px', background: '#65c458', color: '#fff', fontWeight: 800, fontSize: 13, cursor: 'pointer' };
...
const whatsappButton = { flex: 1, textAlign: 'center' as const, textDecoration: 'none', borderRadius: 8, padding: '9px 8px', background: '#e0f3f0', color: '#65c458', fontWeight: 800, fontSize: 12 };
