...
export default function ModificarProductoBuffetModal() {
  ...
  return (
    <ModalOverlay onClose={actions.closeModificarProductoBuffet} maxWidth={420} ariaLabel={`Modificar ${producto.nombre}`}>
      ...
      <FotoUploadInput foto={producto.foto || ''} onFotoChange={(dataUrl) => actions.setFotoProductoBuffet(producto.id, dataUrl)} onQuitar={() => actions.setFotoProductoBuffet(producto.id, '')} />
