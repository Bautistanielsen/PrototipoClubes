...
export default function SocioModal() {
  ...
  return (
    <ModalOverlay onClose={actions.closeSocioModal} maxWidth={480} ariaLabel="Nuevo socio">
      <div style={{ fontSize: 19, fontWeight: 800, color: '#16203a', marginBottom: 5 }}>Nuevo socio</div>
      <p style={{ color: '#6b7488', fontSize: 13, lineHeight: 1.45, margin: '0 0 18px' }}>Se da de alta con la cuota al día desde hoy.</p>
      ...
      <div style={{ display: 'flex', gap: 10 }}>
        ...
        <button onClick={actions.guardarSocio} style={primaryButton}>Agregar socio</button>
      </div>
    </ModalOverlay>
  );
}
