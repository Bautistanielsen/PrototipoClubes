      ...
      <main>
        ...
        <section className="landing-pilot landing-shell" id="piloto" aria-labelledby="pilot-title">
          ...
          <div className="landing-pilot-details">
            ...
            <aside className="landing-pilot-offer" aria-label="Beneficio exclusivo para los primeros 10 clubes fundadores">
              <span className="landing-pilot-offer-icon" aria-hidden="true">
              ...
              <div className="landing-pilot-offer-content">
                <h3 className="landing-pilot-offer-title">Beneficio exclusivo para los primeros 10 clubes fundadores</h3>
                <p className="landing-pilot-offer-body">Con la contratación del sistema, se entregará una web institucional GRATUITA.</p>
              </div>
            </aside>
